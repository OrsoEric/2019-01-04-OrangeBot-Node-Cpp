...
//myAddon.parse("PWM:+100:+100");
//console.log("pwm0:", myAddon.getPwm(0));
...
(
	...
	function (socket)
	{
		...
		(
			function()
			{
				socket.emit("server_time", { server_time: get_server_time(), pwm0 : myAddon.getPwm(0), pwm1 : myAddon.getPwm(1)  });
			},
			//Send every 333ms
			333
		);
